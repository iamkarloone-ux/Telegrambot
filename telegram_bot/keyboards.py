...
def get_patch_menu_keyboard(tier: str = "premium"):
    """Generates inline keyboard for main action menu depending on user tier."""
    if tier == "free":
        return InlineKeyboardMarkup(
            inline_keyboard=[
                [InlineKeyboardButton(text="1️⃣ Ban-Safe Pack 1 (10M/6K) 🔒", callback_data="premium_locked")],
                [InlineKeyboardButton(text="2️⃣ Ban-Safe Pack 2 (6M/1K) ✅", callback_data="patch_safe_2")],
                [InlineKeyboardButton(text="3️⃣ Custom Resources 🔒", callback_data="premium_locked")],
                [InlineKeyboardButton(text="4️⃣ Max Nitro 🔒", callback_data="premium_locked")],
                [InlineKeyboardButton(text="5️⃣ Map Unlock Only 🔒", callback_data="premium_locked")],
                [InlineKeyboardButton(text="6️⃣ Inject Custom Car 🔒", callback_data="premium_locked")],
